...
class VisualQualityManager:
    ...
    def should_use_high_quality_mode(self, engagement_priority: float = 0.7) -> bool:
        """
        ...
        """
        # Balancear qualidade visual vs engajamento
        quality_weight = 1.0 - engagement_priority
        return random.random() < quality_weight + 0.3  # Bias para qualidade
...
def get_enhanced_image_prompt(content_theme: str = "growth and leadership",
                            ...
                            force_high_quality: bool = False) -> Tuple[str, Dict]:
    """
    ...
    # Decidir se usar modo de alta qualidade
